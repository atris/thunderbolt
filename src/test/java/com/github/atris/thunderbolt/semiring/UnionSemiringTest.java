...
public class UnionSemiringTest {
  ...
  public void testTimes1() {
    ...
    Assert.assertEquals(ImmutableList.of(GallicSemiring.GallicWeight.createFromGiven(56.0, 9, 10)),
    ...
    Assert.assertEquals(ImmutableList.of(GallicSemiring.GallicWeight.createFromGiven(56.0, 10, 9)),
    ...
    Assert.assertEquals(ImmutableList.of(GallicSemiring.GallicWeight.createFromGiven(85.0, 9, 10, 11),
    ...
    Assert.assertEquals(ImmutableList.of(GallicSemiring.GallicWeight.createFromGiven(85.0, 10, 11, 9),
  ...
  public void testDivideLeftSingular() {
    ...
    Assert.assertEquals(ImmutableList.of(GallicSemiring.GallicWeight.createFromGiven(30.0)),
    ...
    Assert.assertEquals(ImmutableList.of(GallicSemiring.GallicWeight.createFromGiven(29.0, 11)),
    ...
    Assert.assertEquals(ImmutableList.of(GallicSemiring.GallicWeight.createFromGiven(-7.0)),
      gallicUnionRing.divide(
  ...
  public void testDivideRightSingular() {
    ...
    Assert.assertEquals(ImmutableList.of(GallicSemiring.GallicWeight.createFromGiven(-29.0)),
    ...
    Assert.assertEquals(ImmutableList.of(GallicSemiring.GallicWeight.createFromGiven(-37.0)),
